...
| [scout.md](scout.md) | Evaluates an external URL against your repo with a have / improve / borrow / adopt / skip verdict per concept, and persists a dated report. Run when someone sends you a tool or repo worth a look. |
