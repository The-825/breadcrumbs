...
| [COOPERATIVE_INTELLIGENCE_EVALUATION_TEMPLATE.md](COOPERATIVE_INTELLIGENCE_EVALUATION_TEMPLATE.md) | Bounded evaluation record for human-AI work: separate orientation, handoff, correction, ownership, recovery, and best-baseline comparison before claiming collaboration improved. |
| [breadcrumb-score/](breadcrumb-score/README.md) | Evidence-scoped readiness scoring for agents and repositories: unknown stays unscored, cited dimensions produce coverage and a deterministic result, and public-ready output requires owner review. |
| [a2a-score-export/](a2a-score-export/README.md) | Non-required A2A Agent Card extension linking a public card to an unexpired, publication-approved Breadcrumb Score assessment. |
