...
| C-004 | ArXiv preprint; abstract-screened staged soccer-analysis participant study | D2 adjacent | XAI-BEHAVIOR | single | abstract-only; small domain-specific task study; incomplete tasks retained; completed-task perceptions do not establish general effectiveness | CI-006, CI-012 | candidate; source identity verified, claims not assessed |
| C-005 | ArXiv preprint; abstract-screened observational agent-network study with selected interviews and survey | D1 analog | PORTFOLIO-DIVERSITY | longitudinal | abstract-only; association, not causation; social-agent setting and selected respondents limit transfer; no repository benefit shown | CI-015 | candidate; source identity verified, claims not assessed |
| C-006 | ArXiv preprint; abstract-screened five-day randomized personalization study | D2 adjacent | LONGITUDINAL-INTERACTION | longitudinal | abstract-only; brief advice-seeking setting; exposure and personalization effects must remain separate; disclosure is not benefit | CI-004, CI-009 | candidate; source identity verified, abstract claims screened |
| C-007 | ArXiv preprint; abstract-screened prototype study and interviews with 31 researchers | D2 adjacent | VERIFICATION | single | abstract-only; proctored manuscript-specific task; small sample; automated score is not general competence or a workplace gate | CI-012, CI-017 | candidate; source identity verified, abstract claims screened |
| C-008 | Nature article; public article-screened computational framework and case studies | D2 adjacent | REPRODUCIBILITY | technical | builder evaluation; computational research domains; reference-output reproduction does not establish human understanding or safe transfer to new data | CI-012, CI-017 | candidate; source identity verified, framework claims not independently replicated |
