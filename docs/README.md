...
| [collaborative-intelligence-repository-landscape.md](collaborative-intelligence-repository-landscape.md) | A public ledger of 311 assessed repositories: 206 pinned detailed appraisals plus 105 triaged portable-only identity and provenance records. Read it with the [Wave R3 detailed inventory](collaborative-intelligence-repository-landscape-wave-r3.md), [Wave R4 review manifest](collaborative-intelligence-repository-wave-r4-reviews.json), [Wave R5 triage manifest](collaborative-intelligence-repository-wave-r5-triage.json), [repository appraisal method](collaborative-intelligence-repository-landscape-method.md), [machine-readable register](collaborative-intelligence-repository-landscape.json), and [collection log](collaborative-intelligence-repository-collection-log.md). |
| [workflow-registry.md](workflow-registry.md) | A generated public discovery view of evidence-screened agent workflows, with community signals kept separate from quality and adoption. The [machine registry](workflow-registry.json) and [Jarvis routing projection](jarvis-workflow-routing.json) are the canonical agent-readable surfaces. |
| [cooperative-intelligence-evaluation.md](cooperative-intelligence-evaluation.md) | Pattern-only evaluation for work shared by people and AI: compare the right baseline, then measure orientation, handoff, correction, ownership, and recovery separately. |
