...
| [collaborative-intelligence-repository-landscape.md](collaborative-intelligence-repository-landscape.md) | A pinned first cohort of 15 public repositories that codify collaboration through runtimes, workflows, protocols, memory, and research frameworks. Read it with the [repository appraisal method](collaborative-intelligence-repository-landscape-method.md), [machine-readable register](collaborative-intelligence-repository-landscape.json), and [collection log](collaborative-intelligence-repository-collection-log.md). |
