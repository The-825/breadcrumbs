...
| [collaborative-intelligence-repository-landscape.md](collaborative-intelligence-repository-landscape.md) | A pinned, aspect-balanced cohort of 25 public repositories that codify collaboration through runtimes, workflows, protocols, memory, retrieval, evaluation, observability, guardrails, and control planes. Read it with the [repository appraisal method](collaborative-intelligence-repository-landscape-method.md), [machine-readable register](collaborative-intelligence-repository-landscape.json), and [collection log](collaborative-intelligence-repository-collection-log.md). |
