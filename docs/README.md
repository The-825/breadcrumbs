...
| [collaborative-intelligence-research-ledger.md](collaborative-intelligence-research-ledger.md) | A versioned four-source research method for testing the broader collaborative-intelligence frame: common review fields, architecture-impact labels, corroboration matrix, dependency map, negative-evidence requirement, and ranked questions. |
