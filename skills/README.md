...
| [ecosystem-scout.md](ecosystem-scout.md) | Mine every external tool, repo, or talk for transferable concepts before any fit judgment: five honest dispositions per concept, artifact separated from idea, doc-overwriting tools disqualified by default, and a follow list that compounds. |
